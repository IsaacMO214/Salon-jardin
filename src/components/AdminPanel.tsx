...
export default function AdminPanel() {
  ...
  if (!data) {
    return (
      <div className="min-h-screen bg-zinc-950 flex flex-col justify-center items-center text-zinc-100 p-4 space-y-4">
        ...
        <button
          onClick={loadData}
          className="px-4 py-2 bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs rounded-xl cursor-pointer shadow-md"
        >
          Reintentar Carga
        </button>
      </div>
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 flex flex-col md:flex-row">
        ...
        <div>
          <div className="p-5 border-b border-zinc-800 flex items-center gap-3">
            ...
            <div>
              ...
              <span className="text-[10px] font-bold text-emerald-400 uppercase tracking-widest block mt-1">Admin Panel</span>
            </div>
          </div>
      ...
      {statusMessage && (
        <div className="fixed bottom-6 right-6 z-50 bg-emerald-600 text-white px-5 py-3 rounded-xl shadow-2xl flex items-center gap-2 animate-bounce font-bold text-xs">
