    ...
    <section id="nosotros" className="py-16 doodle-leaves-bg scroll-mt-10 border-b border-slate-100 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          {/* Left: History Card */}
          <div className="lg:col-span-7 flex flex-col justify-center bg-white/80 backdrop-blur-xs rounded-xl border border-green-100/40 p-6 sm:p-8 shadow-xs hover:border-green-200/60 transition-all duration-350">
          ...
          <div className="lg:col-span-5 flex flex-col justify-center gap-4">
            {stats.map((stat, idx) => (
              <motion.div
                ...
                className="bg-white border border-slate-100 rounded-xl p-4 shadow-xs flex items-center gap-4 hover:border-green-100 hover:shadow-xs transition-all duration-350 cursor-default"
              >
                <div className="bg-green-50 p-2.5 rounded-lg text-green-700 shrink-0">
                  {stat.icon}
                </div>
                <div>
                  <div className="text-lg font-bold text-green-900 tracking-tight leading-none mb-1">
                    {stat.number}
                  </div>
