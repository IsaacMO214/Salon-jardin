...
export default function AdminDashboard({ data, setActiveTab }: AdminDashboardProps) {
  return (
    <div className="space-y-8 animate-fadeIn">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-fantasy-purple-950/80 via-zinc-900 to-zinc-900 border border-fantasy-purple-500/30 rounded-2xl p-6 sm:p-8 shadow-xl">
        <div className="absolute top-0 right-0 -mt-6 -mr-6 w-32 h-32 bg-fantasy-purple-500/10 rounded-full blur-2xl pointer-events-none"></div>
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5 relative z-10">
          <div className="w-14 h-14 shrink-0 bg-fantasy-purple-500/20 border border-fantasy-purple-400/40 rounded-2xl flex items-center justify-center text-fantasy-purple-300 shadow-inner">
      ...
      <div className="space-y-4">
        <h4 className="text-xs font-bold uppercase tracking-widest text-fantasy-purple-400">
          Resumen de Contenidos & Acceso Rápido
        </h4>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {/* Card Eventos */}
          <div className="bg-zinc-800/50 border border-zinc-800 hover:border-fantasy-purple-500/40 p-5 rounded-2xl transition-all flex flex-col justify-between space-y-4 group">
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <span className="p-2.5 bg-fantasy-purple-950/80 text-fantasy-purple-400 border border-fantasy-purple-500/20 rounded-xl">
                  <Calendar className="w-5 h-5" />
                </span>
                <span className="text-xs font-extrabold text-fantasy-purple-400 bg-fantasy-purple-950/60 border border-fantasy-purple-500/30 px-2.5 py-0.5 rounded-full">
                  {data.eventos?.length || 0} Tipos
                </span>
              </div>
              <h5 className="font-bold text-base text-zinc-100 group-hover:text-fantasy-purple-300 transition-colors">
                Eventos Especiales
              </h5>
            ...
            <button
              ...
              className="w-full py-2 bg-zinc-800 hover:bg-fantasy-pink-600 text-zinc-200 hover:text-white rounded-xl text-xs font-bold transition-all flex items-center justify-center gap-1.5 cursor-pointer shadow-xs"
            >
